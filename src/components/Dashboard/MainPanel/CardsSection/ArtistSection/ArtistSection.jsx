...
const ArtistSection = ({ className }) => {
  return (
    <section className={`pt-0 pb-0 ${className}`}>
      <div className="w-100 d-flex justify-content-start gap-4 flex-wrap mt-0 ">
        {ArtistToolsData.map((tool, index) => (
          // <div key={index} className="col-lg-12 col-md-6 bg_light_dark rounded-4 border border-warning">
          ...
          >
            <div className="al_card bg_light_dark rounded-4 py-2 px-3 ">
              ...
              <div className="card_content d-flex justify-content-between my-3  px-2">
                <div className="">
